...
#define resetButtonString                  "Сброс"
#define devicesButtonString                "Устройства"
#define editPathButtonString               "Путь"
#define searchString                       "Поиск:"
#define dirEntryString                     "[Каталог]"
#define linkEntryString                    "[Ссылка]"
#define fileEntryString                    "[Файл]"
#define fileNameString                     "Имя файла:"
#define dirNameString                      "Каталог:"
#define buttonResetSearchString            "Сбросить поиск"
#define buttonDriveString                  "Устройства"
#define buttonEditPathString               "Изменить путь\nПуть также можно изменить правой кнопкой мыши"
#define buttonResetPathString              "Вернуться в текущий каталог"
#define buttonCreateDirString              "Создать каталог"
#define OverWriteDialogTitleString         "Выбранный файл уже существует"
#define OverWriteDialogMessageString       "Перезаписать существующий файл?"
#define OverWriteDialogConfirmButtonString "Перезаписать"
#define OverWriteDialogCancelButtonString  "Отмена"

// Validation buttons
#define okButtonString "ОК"
